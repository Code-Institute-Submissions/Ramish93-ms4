...
from gallery.views import (
    ...
    PaymentSuccessTemplateView, PaymentCancelledTemplateView, AddRemoveToCartView
)
...
urlpatterns = [
    ...
    path('cart/add-remove-to-cart', AddRemoveToCartView.as_view(), name='add_to_cart_view'),
